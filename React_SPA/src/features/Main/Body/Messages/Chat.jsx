...
function Chat() {
    ...
    const helperfun = (obj) => {
        setString(obj);
        var myInput = document.getElementById("inputMsg");
        var myButton = document.getElementById("sendMsg");
    
            console.log('###')
            if (myInput.value !== "") {
            myButton.classList.add("filled");
            }
    ...
    const msgAdding = (obj) => {
        ...
        var myButton = document.getElementById("sendMsg");
        myButton.classList.remove("filled");
        // setTimeout = (() => {
        ...
        <div class="chat" >
            ...
            <div class="message_input_bg">
                <div class="message_input" >
                        ...
                        <button id='sendMsg' onMouseEnter={() => {changeSendBtn()}}  onClick={() => {msgAdding(idAndMsg)}} ><img id='sendImgIcon' src={process.env.PUBLIC_URL + '/images/Messages/send.svg'} alt="" width="20px" height="20px" /></button>
                </div>
            </div>
        </div>
